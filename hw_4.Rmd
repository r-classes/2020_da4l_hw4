...
### task 4.1.1
Выведите в консоль значение комулитивной дисперсии, объясненной двумя первыми компонентами.
...
### task 4.1.3
Есть ли какая-то логика в росположении переменных многочисленного кластера переменных? Напишите ниже, если вы видите закономерность и перечислите противоречивые переменные. Так как все накладывается имеет смысл зумиться при помощи команды `scale_y_continuous(limits = c(0, 0.3))`, в которой нужно указать нужный промежуток.
